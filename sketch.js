...
var star, star2;
var star_img;
var starDisplay, star_1, star_2, star_empty;
...
function preload()
{
  ...
  star_empty = loadImage('empty.png')
...
function setup() 
{
  ...
  star = createSprite(315,90)
  star.addImage(star_img)
  star.scale = 0.02

  star2 = createSprite(130,310)
  star2.addImage(star_img)
  star2.scale = 0.02

  starDisplay = createSprite(50,50)
  starDisplay.addImage(star_empty)
...
function draw() 
{
  ...
  if(score === 1){
    starDisplay.addImage(star_1)
  }else if(score === 2){
    starDisplay.addImage(star_2)
  }
